...
model_params_by_meter = {
    "meter0":{'num_iterations':450,
              'num_leaves':152, 
              'learning_rate':0.024720622660496384, 
              'min_data_in_leaf':20,
              'feature_fraction':0.9, 
              'lambda_l2':2.0},
    "meter1":{'num_iterations':200,
              'num_leaves':50, 
              'learning_rate':0.0643892232451026, 
              'min_data_in_leaf':15, 
              'feature_fraction':0.9, 
              'lambda_l2':2.0},
    "meter2":{'num_iterations':500,
              'num_leaves':120, 
              'learning_rate':0.036170009520501305, 
              'min_data_in_leaf':25, 
              'feature_fraction':0.8, 
              'lambda_l2':1.0}	,
    "meter3":{'num_iterations':100,
              'num_leaves':93, 
              'learning_rate':0.031113983853702905, 
              'min_data_in_leaf':25, 
              'feature_fraction':0.9, 
              'lambda_l2': 0.0}	
}
